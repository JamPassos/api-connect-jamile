...
Ou, em modo de desenvolvimento (com reinício automático a cada alteração):
...
Todas as rotas abaixo utilizam o prefixo `/users` e trocam dados exclusivamente em formato JSON.
